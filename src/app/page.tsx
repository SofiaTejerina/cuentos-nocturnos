...
function NavBar() {
    return <div className="bg-white">
        <div
            className="p-5 flex justify-between w-screen px-[75px] text-[30px] font-last-didone font-hairline gap-12 text-blueFlor">
            <Link href="/">
                <div>Inicio</div>
            </Link>
            <Link href="/">
...
function BookPresentation() {
    return <div className="flex w-screen justify-center bg-white">
        <Image className="shadow-[rgba(0,0,15,0.5)_10px_5px_4px_0px] mt-[65px]" src="/portada.png" alt="Portada libro"
               width={183} height={271}/>
...
function BookDescription() {
    return <div className="flex pt-[33px] bg-white">
        ...
        <div className="bg-blue-flor text-white font-serif w-1/2 pt-[77px] px-[56px]">
            ...
            <p className="max-w-2xl pt-[20px] text-[12pt]">
                ...
                oscuros del miedo y la paranoia. Desde susurros inquietantes hasta revelaciones escalofriantes, este
                libro es un viaje a través del
